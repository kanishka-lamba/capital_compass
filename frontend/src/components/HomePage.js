  ...
  return (
    <div className="mx-64 my-36">
      ...
      <div className="flex h-screen">
        <div className="w-full md:w-1/3 px-4 mt-8">
          <form onSubmit={handleSubmit} className="flex flex-col items-center">
            ...
            <button
              type="submit"
              className=" bg-blue-700 text-white py-2 px-4 rounded-md hover:bg-blue-200 transition duration-300 w-full text-2xl mt-2"
        ...
        <div className="hidden md:block w-full md:w-2/3 px-4">
          <div className=" rounded-md p-4">
            <h1>Get the summary response </h1>
            {loading && (
              <button
                disabled
                type="button"
